...
public class HttpUtility {
    ...
    public static Box getBox(HttpServletRequest req)  {
        ...
        while(e.hasMoreElements()){
            ...
            if ("ENCRYPTED_DATA".equals(key) || "JS_CODE".equals(key) || "IV".equals(key) || "EVENT_DESC".equals(key)
                    || "VIDEO_NAME".equals(key) || "VIDEO_DESC".equals(key) || "EVENT_IMAGE_DESC".equals(key)) {
                box.put(key, req.getParameter(key));
            } else {
                box.put(key, replaceSpecialCharacter(req.getParameter(key)));
            }
        }
        ...
        while(e.hasMoreElements()){
            String key = (String)e.nextElement();
            box.put(key, replaceSpecialCharacter(req.getAttribute(key).toString()));
        }
    ...
    protected static String replaceSpecialCharacter(String val) {
        String rtnVal = val;
        try {
