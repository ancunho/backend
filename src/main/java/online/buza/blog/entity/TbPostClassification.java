...
public class TbPostClassification {
    private Integer postClassificationId;
    ...
    public Integer getPostClassificationId() {
        return postClassificationId;
    }

    public void setPostClassificationId(Integer postClassificationId) {
        this.postClassificationId = postClassificationId;
    }
    ...
    public String toString() {
        ...
        sb.append(", postClassificationId=").append(postClassificationId);
