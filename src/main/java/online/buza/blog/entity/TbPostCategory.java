...
public class TbPostCategory {
    ...
    public String toString() {
        ...
        sb.append(", postCategoryParentId=").append(postCategoryParentId);
        sb.append(", postCategoryName=").append(postCategoryName);
        sb.append(", postCategoryStatus=").append(postCategoryStatus);
        sb.append(", postCategoryDesc=").append(postCategoryDesc);
